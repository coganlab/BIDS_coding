...
SUB_IDS=(D53) #(D22 D23 D24 D25 D28 D29 D31 D35 D39 D40 D41 D42 D45 D49 D53 D54 D55 D56 D58)
TASKS=(Sentence_Rep)
...
for TASK in "${TASKS[@]}"
 do
    ...
    OUTPUT_DIR="$ORIG_DATA_DIR/BIDS-1.0_Sentence_Rep/Error" #"$HOME/Desktop/Workspace/sourcedata/$TASK"
